...
import { IndexExpoComponent } from './pages/index/index-expo/index-expo.component';

export const routes: Routes = [
    {path:'', component:IndexExpoComponent},
    ...
    {path:'index-expo', component:IndexExpoComponent},
